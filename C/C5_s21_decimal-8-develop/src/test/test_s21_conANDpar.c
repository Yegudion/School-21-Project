...
START_TEST(float_power) {
  ...
  float a = 0.0;
  float b = -0.8;
  s21_set_dec_scale_factor(&value, 1);
  s21_set_dec_sign(&value, 1);
  s21_from_decimal_to_float(value, &a);
  ck_assert_float_eq(a, b);
}
END_TEST
...
START_TEST(float_big_power) {
  ...
  s21_set_dec_scale_factor(&value, 28);
  s21_set_dec_sign(&value, 1);
  s21_from_decimal_to_float(value, &a);
  ck_assert_float_eq(a, b);
}
...
START_TEST(float_power_max_value) {
  ...
  float a = 0.0;
  float b = -1.47484107;
  s21_set_dec_scale_factor(&value, 8);
  s21_set_dec_sign(&value, 1);
  s21_from_decimal_to_float(value, &a);
...
START_TEST(float_power_max_dec) {
  ...
  s21_set_dec_scale_factor(&value, 11);
  s21_set_dec_sign(&value, 1);
  s21_from_decimal_to_float(value, &a);
  ck_assert_float_eq_tol(a, b, 1e-6);
}

...
START_TEST(set_scale) {  //[s0000000ffffffff0000000000000000]
  s21_decimal dec1t1 = {{0, 0, 0, 0b00000000000111000000000000000000}},
              dec2t1 = {0};
  s21_decimal dec1t2 = {{0, 3, 0, 0b10000000000000000000000000000000}},
              dec2t2 = {{0, 3, 0, 0b10000000000110010000000000000000}};
  s21_decimal dec1t3 = {{0, 5, 0, 0b10000000000110010000000000000000}},
              dec2t3 = {{0, 5, 0, 0b10000000000000000000000000000000}};
  s21_decimal dec1t4 = {{7, 0, 0, 0b00000000000011100000000000000000}},
              dec2t4 = {{7, 0, 0, 0b00000000000110010000000000000000}};

  s21_set_dec_scale_factor(&dec1t1, 0);
  s21_set_dec_scale_factor(&dec1t2, 25);
  s21_set_dec_scale_factor(&dec1t3, 0);
  s21_set_dec_scale_factor(&dec1t4, 25);
...
START_TEST(set_error) {
  s21_decimal dec1t1 = {{1, 0, 0, 0b00000000000111000000000000000000}},
  ...
  ck_assert_int_eq(s21_set_dec_scale_factor(&dec1t1, 29), 1);
  ck_assert_int_eq(s21_set_dec_scale_factor(&dec1t2, -23), 1);
  ck_assert_int_eq(s21_set_dec_scale_factor(&dec1t3, 100), 1);
  ck_assert_int_eq(s21_set_dec_scale_factor(&dec1t4, -1), 1);
  ck_assert_int_eq(s21_set_dec_scale_factor(&dec1t5, 3), 0);
}
END_TEST
...
START_TEST(get_scale) {
  ...
  s21_get_dec_scale_factor(dec1t1, &scale1);
  s21_get_dec_scale_factor(dec1t2, &scale2);
  s21_get_dec_scale_factor(dec1t3, &scale3);
  s21_get_dec_scale_factor(dec1t4, &scale4);
  s21_get_dec_scale_factor(dec1t5, &scale5);

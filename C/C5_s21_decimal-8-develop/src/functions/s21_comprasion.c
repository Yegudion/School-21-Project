...
int s21_is_less(s21_decimal op_2, s21_decimal op_1) {
  int ret_bool, sign_op_1, sign_op_2, factor_op_1, factor_op_2;
  s21_get_dec_sign(op_1, &sign_op_1);
  s21_get_dec_sign(op_2, &sign_op_2);
  s21_get_dec_scale_factor(op_1, &factor_op_1);
  s21_get_dec_scale_factor(op_2, &factor_op_2);

  if (s21_is_not_equal(op_1, op_2)) {
